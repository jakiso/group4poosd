    ...
    return (props.folderType==="food") ? ( 
        <div>
            ...
            props.arr_food.map(({ folderId, folderName, folderType }) => (
                ...
                onClick={()=>{props.setSaveToListMode(false);}} setNewFolder={props.setNewFolder} update={props.update} setUpdate={props.setUpdate}
                isDisabled={props.isDisabled} setIsDisabled={props.setIsDisabled} setNewName={props.setNewName}/>
            ))
            }
        </div>
